...
public class TestMatrixSerializerGenerator
{
    ...
    [Test]
    public void LoadSnapshot_IntoNull_CreateInstance()
    {
        var serializer = _context.RequireSerializer<int[,]>();
    ...
    [Test]
    public void LoadSnapshot_IntoDifferentShape_CreateInstance()
    {
        var serializer = _context.RequireSerializer<int[,]>();
    ...
    [Test]
    public void LoadSnapshot_IntoSameShape_CreateInstance()
    {
        var serializer = _context.RequireSerializer<int[,]>();
